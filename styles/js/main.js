        ...
        giftBox.innerHTML = `
            ...
            <div class="gift-options">
                <div class="gift-option">
                    <h4>💳 轉帳</h4>
                    <div class="copy-all-text" onclick="copyBankInfo('060312222631', 'Sacombank', 'HOANG VAN TOAN')" title="點擊複製全部">
                        <p>帳號：<span class="highlight">060312222631</span></p>
                        <p>銀行：<span class="highlight">Sacombank</span></p>
                        <p>戶名：HOANG VAN TOAN</p>
                        <div class="copy-hint">📋 點擊複製全部</div>
                    </div>
                    <div class="qr-code-container">
                        <img src="styles/img/QR chu re.png" alt="新郎 QR Code" class="qr-code-image">
                    </div>
                </div>
            </div>
            <div class="gift-note">
                <p><i class="fas fa-heart"></i> 您的每一份心意都是最珍貴的禮物！</p>
            </div>
        `;
    } else if (type === 'bride') {
        giftBox.innerHTML = `
            ...
            <div class="gift-options">
                <div class="gift-option">
                    <h4>💳 轉帳</h4>
                    <div class="copy-all-text" onclick="copyBankInfo('105879121162', 'VietinBank', 'NGUYEN THI MAI DUYEN')" title="點擊複製全部">
                        <p>帳號：<span class="highlight">105879121162</span></p>
                        <p>銀行：<span class="highlight">VietinBank</span></p>
                        <p>戶名：NGUYEN THI MAI DUYEN</p>
                        <div class="copy-hint">📋 點擊複製全部</div>
                    </div>
                    <div class="qr-code-container">
                        <img src="styles/img/QR co dau.png" alt="新娘 QR Code" class="qr-code-image">
                    </div>
                </div>
            </div>
            <div class="gift-note">
...
function copyBankInfo(accountNumber, bankName, accountHolder) {
    const bankInfo = `帳號：${accountNumber}\n銀行：${bankName}\n戶名：${accountHolder}`;
    
    navigator.clipboard.writeText(bankInfo).then(function() {
        showNotification('已複製帳戶資訊！', 'success');
    }).catch(function(err) {
        // 舊版瀏覽器備用方案
...
function updateMusicInfo(musicSrc) {
    ...
    if (musicInfo) {
        ...
        musicInfo.textContent = `正在播放：${fileName}`;
    }
}
